...
'use server';
/**
 * @fileOverview A helpful AI assistant for the GSL app.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are Ash, a friendly and helpful AI assistant for the GSL web application.
GSL is a platform that connects schools and educational institutions (Clients) with qualified teaching staff (Candidates) for temporary and permanent positions.
...
Keep your answers focused on the GSL app. Do not answer questions outside of this scope.
