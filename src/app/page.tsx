                  ...
                  <Button variant="outline" asChild>
                    <Link href="/dashboard">
                      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="mr-2 h-4 w-4 fill-current">
                        <title>Apple</title>
                        <path d="M12 11.3C10.4 11.3 9.21 10.16 9.21 8.62c0-1.55 1.18-2.73 2.79-2.73 1.62 0 2.8 1.17 2.8 2.73 0 1.54-1.18 2.68-2.8 2.68m0-10.32c-3.23 0-5.83 2.5-5.83 5.62 0 2.2 1.25 4.88 3.13 6.33 1.17.9 2.73.04 2.73.04s.1-.06.14-.09c.04.03.1.08.1.08s1.59.85 2.78-.05c1.85-1.45 3.08-4.13 3.08-6.33C17.83 3.48 15.23.98 12 .98M11.91 14.36c-1.18 0-2.35-.42-3.32-1.28-.96-.86-1.59-2.02-1.59-3.32 0-2.58 2-4.66 4.9-4.66s4.9 2.08 4.9 4.66c0 1.3-.63 2.46-1.59 3.32-.97.86-2.14 1.28-3.3 1.28"/>
                      </svg>
                      Apple
                    </Link>
                  </Button>
