...
export const mockCandidates: Candidate[] = [
  {
    ...
    qualifications: ['PhD in History', 'Certified Teacher'],
  ...
  },
  {
    ...
    qualifications: ['M.Sc. in Mathematics', '5+ Years Experience'],
  ...
  },
  {
    ...
    reviews: 21,
    location: 'New York, NY',
    qualifications: ['M.Ed', 'Chemistry Specialization'],
  ...
  },
  {
    ...
    qualifications: ['MA in English Lit', 'TEFL Certified'],
