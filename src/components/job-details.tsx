             ...
             <Card>
                ...
                <CardContent className="space-y-6">
                    <div className="space-y-4">
                        <DetailItem icon={Book} label="Subject" value={job.subject || 'N/A'} />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <DetailItem icon={CalendarIcon} label="Start Date" value={job.startDate ? format(new Date(job.startDate), 'PPP') : 'Not specified'} />
                        <DetailItem icon={CalendarIcon} label="End Date" value={job.endDate ? format(new Date(job.endDate), 'PPP') : 'Not specified'} />
                        <DetailItem icon={PoundSterling} label="Pay Rate" value={job.payRate ? `£${job.payRate}`: 'N/A'} />
