...
import { List, ListChecks, CalendarClock, AlertCircle } from 'lucide-react';
         ...
         <div className="grid gap-6 md:grid-cols-2">
            <Card>
                ...
                <CardContent className="space-y-4">
                   ...
                   {recentTimesheet && (
                     <div className="flex items-start gap-4">
                        {recentTimesheet.status === 'Rejected' ? <AlertCircle className="h-6 w-6 text-destructive mt-1" /> : <List className="h-6 w-6 text-primary mt-1" />}
                        <div>
